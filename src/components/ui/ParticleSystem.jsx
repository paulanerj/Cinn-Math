...
// PURPOSE: Canvas-based confetti burst on correct answers and session finale.
export const ParticleSystem = ({ trigger, isFinale }) => {
  ...
  useEffect(() => {
    ...
    let particles = [];
    const createExplosion = (x, y, count, colors) => {
