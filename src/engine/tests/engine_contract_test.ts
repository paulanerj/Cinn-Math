...
export function runEngineContractTests() {
  ...
  try {
    // 1. Practice Targets Verification
    log("--- Test 1: Practice Targets ---");
    const profile = new PracticeProfile([7], 2, 5); // 7 * [2,3,4,5] = 14, 21, 28, 35
    ...
    // 6. Solvability & Distribution Parity (Heuristic)
    ...
    // 7. Solver Mode (Speed Grid) Tests
...
// Auto-run if executed directly (mock environment)
