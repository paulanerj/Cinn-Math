...
// ANIM_REVEAL bridges the shared timing system into the CombineGrid-specific token.
// This is the only value in uiTokens.ts that derives from an external module.
import { ANIM_REVEAL } from '@/src/platform/ui/animTokens';
...
export const FACTOR_REVEAL_DURATION_MS = ANIM_REVEAL;               // ms: one-shot reveal animation duration
